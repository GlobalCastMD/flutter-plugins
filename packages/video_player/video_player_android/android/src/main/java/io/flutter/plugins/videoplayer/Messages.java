...
public class Messages {
  ...
  public static class CreateMessage {
    ...
    private @Nullable ControlsMetadata metadata;
    public @Nullable ControlsMetadata getMetadata() { return metadata; }
    public void setMetadata(@Nullable ControlsMetadata setterArg) {
    ...
    public static final class Builder {
      ...
      private @Nullable ControlsMetadata metadata;
      public @NonNull Builder setMetadata(@Nullable ControlsMetadata setterArg) {
        this.metadata = setterArg;
        return this;
      }
    ...
    static @NonNull CreateMessage fromMap(@NonNull Map<String, Object> map) {
      ...
      pigeonResult.setMetadata((metadata == null) ? null : ControlsMetadata.fromMap((Map)metadata));
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class ControlsMetadata {
    ...
    public static final class Builder {
      ...
      private @Nullable String thumbnailUri;
      public @NonNull Builder setThumbnailUri(@Nullable String setterArg) {
        this.thumbnailUri = setterArg;
        return this;
      }
      private @Nullable byte[] thumbnailBytes;
      public @NonNull Builder setThumbnailBytes(@Nullable byte[] setterArg) {
        this.thumbnailBytes = setterArg;
        return this;
      }
      public @NonNull ControlsMetadata build() {
        ControlsMetadata pigeonReturn = new ControlsMetadata();
        pigeonReturn.setTitle(title);
        pigeonReturn.setSubtitle(subtitle);
        pigeonReturn.setThumbnailUri(thumbnailUri);
        pigeonReturn.setThumbnailBytes(thumbnailBytes);
        return pigeonReturn;
      }
    }
    @NonNull Map<String, Object> toMap() {
      ...
      toMapResult.put("thumbnailUri", thumbnailUri);
      toMapResult.put("thumbnailBytes", thumbnailBytes);
      return toMapResult;
    }
    static @NonNull ControlsMetadata fromMap(@NonNull Map<String, Object> map) {
      ControlsMetadata pigeonResult = new ControlsMetadata();
      Object title = map.get("title");
      pigeonResult.setTitle((String)title);
      Object subtitle = map.get("subtitle");
      pigeonResult.setSubtitle((String)subtitle);
      Object thumbnailUri = map.get("thumbnailUri");
      pigeonResult.setThumbnailUri((String)thumbnailUri);
      Object thumbnailBytes = map.get("thumbnailBytes");
      pigeonResult.setThumbnailBytes((byte[])thumbnailBytes);
      return pigeonResult;
    }
  }
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        case (byte)128:         
          return ControlsMetadata.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      if (value instanceof ControlsMetadata) {
        stream.write(128);
        writeValue(stream, ((ControlsMetadata) value).toMap());
      } else 
