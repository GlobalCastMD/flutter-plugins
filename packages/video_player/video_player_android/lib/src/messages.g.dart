...
class CreateMessage {
  ...
  Object encode() {
    ...
    pigeonMap['metadata'] = metadata == null ? null : metadata!.encode();
  ...
  static CreateMessage decode(Object message) {
    ...
    return CreateMessage(
      ...
      metadata: pigeonMap['metadata'] != null
          ? ControlsMetadata.decode(pigeonMap['metadata']!)
          : null,
...
class ControlsMetadata {
  ...
  Object encode() {
    ...
    pigeonMap['thumbnailUri'] = thumbnailUri;
    pigeonMap['thumbnailBytes'] = thumbnailBytes;
    return pigeonMap;
  }

  static ControlsMetadata decode(Object message) {
    final Map<Object?, Object?> pigeonMap = message as Map<Object?, Object?>;
    return ControlsMetadata(
      title: pigeonMap['title']! as String,
      subtitle: pigeonMap['subtitle']! as String,
      thumbnailUri: pigeonMap['thumbnailUri'] as String?,
      thumbnailBytes: pigeonMap['thumbnailBytes'] as Uint8List?,
    );
  }
}
    ...
    } else 
{
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128:       
        return ControlsMetadata.decode(readValue(buffer)!);
